...
(과목 › 주요항목 › 세부항목)를 노트 한 편 분량씩 쪼갠 목록이고, 개념 372편과
모의고사 69편으로 모두 441편이다. 주제마다 제목·과목·`keywords`(그 노트가 반드시
...
주제를 쓴다(2026-08-27에 2편에서 올렸다 — 441편을 2편/일로 채우면 220일이다). 계획을 넣기 전에 쓴 과목 통째 노트(ADsP 셋·AICE 넷)는 그 번호를 쓸
