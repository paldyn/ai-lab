...
import { mirrorIndexPlugin } from './plugins/mirror-index';
import { playbookIndexPlugin } from './plugins/playbook-index';
...
export default defineConfig({
  ...
  plugins: [markdownPlugin(), articleIndexPlugin(), certPrepIndexPlugin(), playbookIndexPlugin(), mirrorIndexPlugin(), react()],
