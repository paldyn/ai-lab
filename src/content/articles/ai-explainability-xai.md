...
draft: false
---
[지난 글](/articles/ai-bias-fairness)에서 AI 편향의 문제를 다뤘다. 편향을 발견하고 수정하려면 AI가 왜 그 결정을 내렸는지 이해해야 한다. 이것이 **설명 가능한 AI**(Explainable AI, XAI)가 필요한 이유다.
...
**지난 글:** [AI 편향과 공정성: 알고리즘 차별을 막는 방법](/articles/ai-bias-fairness)
