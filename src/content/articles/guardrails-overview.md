...
![시스템 프롬프트와 사용자 입력과 문서가 컨텍스트 창 안에서 한 줄이 된다](/assets/posts/guardrails-overview-trust-boundary.svg)
...
![조치 넷은 되돌릴 수 있는 정도로 줄을 선다](/assets/posts/guardrails-overview-actions.svg)
...
![임계값을 옮기면 놓침과 과차단이 맞바뀐다](/assets/posts/guardrails-overview-threshold.svg)
