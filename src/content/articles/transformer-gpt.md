...
draft: false
---
[지난 글](/articles/transformer-bert)에서 BERT가 Encoder만으로 양방향 문맥을 학습하는 방법을 살펴봤다. 같은 시기 OpenAI는 반대 방향으로 나아갔다. **Decoder만 사용**해 다음 토큰을 예측하는 자기 회귀(autoregressive) 언어 모델, **GPT**(Generative Pre-trained Transformer)다.
