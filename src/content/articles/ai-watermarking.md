...
draft: false
---
[지난 글](/articles/ai-jailbreak)에서 LLM 탈옥 공격과 방어를 다뤘다. AI가 생성한 콘텐츠가 폭발적으로 늘면서 새로운 문제가 생겼다. "이게 인간이 쓴 글인가, AI가 만든 이미지인가?" **AI 워터마킹**은 생성 단계에서 보이지 않는 신호를 심어 나중에 AI 생성 여부를 검출하는 기술이다.
