...
draft: false
---
[지난 글](/articles/ai-probability-basics)에서 조건부 확률, 엔트로피, 교차 엔트로피 손실의 관계를 살펴봤다. 이번에는 AI의 핵심 수학 기초 가운데 **베이즈 정리**(Bayes' Theorem)를 다룬다. 베이즈 정리는 18세기 영국 목사 토머스 베이즈(Thomas Bayes)가 고안한 공식이지만, 현대 AI·머신러닝의 철학적 기반이 된다. "새로운 증거를 보고 기존 믿음을 얼마나 바꿔야 하는가?"라는 질문에 수학적으로 답한다.
...
**지난 글:** [AI를 위한 확률론 기초: 불확실성을 다루는 언어](/articles/ai-probability-basics)

**다음 글:** [정보 이론: AI가 불확실성을 측정하는 방법](/articles/ai-information-theory)
