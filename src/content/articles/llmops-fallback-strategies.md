...
![독립 장애와 상관 장애의 실패 확률 비교](/assets/posts/llmops-fallback-strategies-independence.svg)
...
![서킷 브레이커의 상태 전이와 임계값](/assets/posts/llmops-fallback-strategies-breaker.svg)
...
![오류율은 그대로인데 자리별 비율만 달라진 세 상태](/assets/posts/llmops-fallback-strategies-metrics.svg)
