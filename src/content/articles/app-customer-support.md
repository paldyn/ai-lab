...
draft: false
---
[지난 글](/articles/app-internal-search)에서 사내 지식을 검색하는 시스템을 만들었다. 이번에는 외부 고객을 대상으로 하는 **AI 고객 지원 자동화** 시스템을 구축한다. 24/7 즉각 응답, 일관된 품질, 상담원 업무 부담 감소가 핵심 목표다. 단, AI가 모든 것을 처리하려 하면 안 된다. 복잡하거나 감정적으로 예민한 케이스는 반드시 사람 상담원에게 넘겨야 한다.
