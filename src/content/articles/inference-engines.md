...
draft: false
---
[지난 글](/articles/speculative-decoding)에서 투기적 디코딩으로 추론 속도를 높이는 알고리즘을 다뤘다. 이제 이를 실제 서비스에 올리는 도구인 **추론 엔진**을 살펴볼 차례다. vLLM, Hugging Face TGI, llama.cpp, Ollama, SGLang, TensorRT-LLM 등 선택지가 많아 혼란스러울 수 있다. 이 글에서는 각 엔진의 특징, 핵심 기술, 성능, 그리고 어떤 상황에서 무엇을 선택해야 하는지 구체적 기준을 제시한다.
...
**다음 글:** [로컬에서 LLM 돌리기 — llama.cpp와 그 위의 Ollama](/articles/inference-llama-cpp)
