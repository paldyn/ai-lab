...
![API 종량제와 온프레미스의 교차점](/assets/posts/ai-current-landscape-onprem-crossover.svg)
...
![토큰 단가는 내려가는데 작업 하나의 값은 버틴다](/assets/posts/ai-current-landscape-unit-vs-task.svg)
...
![얇은 껍데기와 남는 제품](/assets/posts/ai-current-landscape-thin-wrapper.svg)
