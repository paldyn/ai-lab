...
draft: false
---
[지난 글](/articles/tensorflow-keras)에서 TensorFlow/Keras의 고수준 API를 살펴봤다. 이번에는 사전학습 모델 생태계의 중심인 **HuggingFace Transformers**를 다룬다. BERT·GPT·T5·Llama 등 수만 개의 모델을 동일한 API로 쓸 수 있게 해주는 라이브러리다.
