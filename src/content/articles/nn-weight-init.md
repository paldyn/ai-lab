...
draft: false
---
[지난 글](/articles/nn-mlp)에서 다층 퍼셉트론을 구현하고 학습시켰다. 그런데 신경망이 학습을 시작하기 전, 가중치의 초기값을 어떻게 설정하느냐가 학습 성패를 크게 좌우한다. 잘못된 초기화는 기울기 소실이나 폭발을 유발해 학습 자체를 불가능하게 만들 수 있다. 이번 글에서는 **가중치 초기화**(Weight Initialization)의 수학적 근거와 실무 사용법을 다룬다.
