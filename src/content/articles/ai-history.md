...
draft: false
---
[지난 글](/articles/ai-ml-dl-llm-concepts)에서 AI·ML·DL·LLM이 서로를 포함하는 집합 관계임을 살펴봤습니다. 이번 글에서는 그 개념들이 어떤 역사적 흐름 속에서 탄생했는지를 따라갑니다. AI는 70년간 두 번의 긴 겨울을 겪었고, 그 실패가 오늘날 LLM 시대를 만든 토대가 됩니다.
