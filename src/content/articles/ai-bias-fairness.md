...
draft: false
---
[지난 글](/articles/ai-alignment)에서 AI 정렬의 전체 그림을 살펴봤다. 정렬 문제의 가장 구체적인 사례 중 하나가 **AI 편향**(Bias)이다. 편향은 학습 데이터나 모델 설계에 내재된 체계적 오류로, 특정 집단에게 불리한 결과를 낸다.
...
**지난 글:** [AI 정렬: 인간의 가치와 AI 목표를 일치시키기](/articles/ai-alignment)

**다음 글:** [설명 가능한 AI(XAI): 블랙박스를 열다](/articles/ai-explainability-xai)
