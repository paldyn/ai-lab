...
draft: false
---
[지난 글](/articles/llm-gpt-family)에서 GPT 시리즈가 어떻게 LLM 생태계를 정의했는지 살펴봤다. 그런데 GPT의 거대한 성공 뒤에는 중요한 질문이 따라왔다. "AI를 단순히 더 크게 만드는 것만으로 충분한가? 안전성과 신뢰성은 어떻게 보장하는가?" 이 질문에 정면으로 답하며 등장한 것이 Anthropic과 **Claude 패밀리**다.
