...
draft: false
---
[지난 글](/articles/data-collection)에서 AI 학습 데이터를 수집하는 방법을 다뤘다. 수집된 원시 데이터에는 정답(레이블)이 없다. 지도 학습 모델은 정답 레이블이 있어야 "이게 고양이다", "이 감정은 긍정이다"를 배울 수 있다. 레이블링은 AI 학습의 숨겨진 병목이다.
...
**지난 글:** [데이터 수집: AI 모델의 연료를 모으는 방법](/articles/data-collection)

**다음 글:** [데이터 증강: 적은 데이터로 더 강한 모델 만들기](/articles/data-augmentation)
