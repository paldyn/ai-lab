...
draft: false
---
[지난 글](/articles/cv-controlnet)에서 포즈·깊이·엣지로 이미지 생성을 정밀하게 제어하는 ControlNet을 다뤘다. 이번 글에서는 이미 존재하는 이미지를 **지우고, 확장하고, 스타일을 바꾸고, 특정 요소만 변경**하는 AI 이미지 편집 기법들을 완전 해설한다. 실무에서 생성보다 편집이 더 자주 쓰인다.
