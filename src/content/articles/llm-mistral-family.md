...
draft: false
---
[지난 글](/articles/llm-llama-family)에서 Meta의 LLaMA가 오픈소스 LLM 생태계를 어떻게 폭발시켰는지 살펴봤다. 그런데 오픈소스 LLM 혁명에는 또 다른 주인공이 있다. 2023년 프랑스에서 조용히 등장해, 단 한 개의 모델로 업계 전체를 뒤흔든 **Mistral AI**다. "작지만 강한" 효율성을 무기로 유럽 LLM의 자존심을 세운 이 팀의 이야기를 해부한다.
