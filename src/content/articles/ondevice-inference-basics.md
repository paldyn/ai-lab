...
draft: false
---
[지난 글](/articles/project-cost-optimization)에서 캐싱과 라우팅으로 API 비용을 깎는 방법을 봤다. 그렇게 줄여도 요청당 비용은 남는다. 그 비용을 아예 0으로 만드는 선택지가 하나 있다. 서버로 보내지 않고 사용자의 기기에서 그대로 돌리는 것이다.
