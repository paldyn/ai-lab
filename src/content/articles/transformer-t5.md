...
draft: false
---
[지난 글](/articles/transformer-gpt)에서 GPT가 Decoder-only로 자기 회귀 생성을 하는 방법과 In-Context Learning의 등장을 살펴봤다. 2019년 Google이 발표한 **T5**(Text-To-Text Transfer Transformer)는 다른 방향의 통합을 시도했다. 번역이든, 요약이든, 분류든 — 모든 태스크를 **"텍스트를 받아 텍스트를 출력"** 하는 하나의 프레임워크로 통일한 것이다.
