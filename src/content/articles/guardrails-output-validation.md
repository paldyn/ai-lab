...
![식별자는 세 관문을 지난다](/assets/posts/guardrails-output-validation-id-gates.svg)
...
![판정 모델까지 올라가는 요청을 줄인다](/assets/posts/guardrails-output-validation-judge-cost.svg)
...
![한 문장을 빼도 뺀 자리에 따라 결과가 다르다](/assets/posts/guardrails-output-validation-partial-removal.svg)
