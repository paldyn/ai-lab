...
draft: false
---
[지난 글](/articles/ai-history)에서 AI가 70년간 두 번의 겨울을 거쳐 LLM 시대까지 이른 역사를 살펴봤습니다. 이번 글에서는 AI를 능력 범위로 분류하는 세 유형, **Narrow AI · AGI · ASI**를 정리합니다. 뉴스에서 "AGI 임박"이라는 말을 들을 때, 그것이 정확히 무엇을 의미하는지 판단할 수 있는 기준이 됩니다.
