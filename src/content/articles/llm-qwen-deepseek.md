...
draft: false
---
[지난 글](/articles/llm-mistral-family)에서 유럽 오픈소스 LLM의 혁신, Mistral AI를 살펴봤다. AI 생태계의 지형은 훨씬 더 넓다. 2024~2025년, 중국에서 두 개의 LLM 가문이 조용히 성장해 전 세계를 놀라게 했다. Alibaba Cloud의 **Qwen**과 헤지펀드 출신 스타트업 **DeepSeek**이다. 특히 DeepSeek의 등장은 미국 AI 업계에 실질적인 충격을 줬다.
