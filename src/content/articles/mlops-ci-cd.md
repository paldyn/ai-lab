...
draft: false
---
[지난 글](/articles/mlops-model-registry)에서 모델 레지스트리로 모델 생애주기를 관리하는 방법을 살펴보았다. 이번에는 모델을 자동으로 검증·배포하는 **ML CI/CD 파이프라인** 구축을 다룬다.
...
**다음 글:** [모델 모니터링 — 조용히 틀려 가는 것을 잡는 법](/articles/mlops-monitoring)
