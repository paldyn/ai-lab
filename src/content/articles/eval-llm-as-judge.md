...
draft: false
---
[지난 글](/articles/eval-human-eval)에서 인간 평가의 설계 원리를 살펴보았다. 인간 평가는 신뢰할 수 있지만 느리고 비싸다는 한계가 있다. 모델을 하루에도 수십 번 업데이트하는 현대적 LLM 개발 사이클에서 매번 사람을 동원해 평가하는 것은 현실적으로 불가능하다.
...
**지난 글:** [LLM 인간 평가: 신뢰할 수 있는 정성 평가 설계하기](/articles/eval-human-eval)  
**다음 글:** [ELO 레이팅으로 LLM 순위 매기기](/articles/eval-elo-ratings)
