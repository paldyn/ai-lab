...
draft: false
---
[지난 글](/articles/prompt-react)에서 외부 도구와 상호작용하는 ReAct를 살펴봤다. 이번 글에서는 훨씬 단순하면서도 강력한 기법인 **Self-Consistency**를 다룬다. 2022년 Wang et al.이 제안한 이 방법은 핵심 아이디어가 명쾌하다. "한 번 물어보지 말고 여러 번 물어본 뒤 다수결로 결정하라."
