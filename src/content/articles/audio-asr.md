...
![CTC와 인코더-디코더가 정렬을 다루는 방식](/assets/posts/audio-asr-ctc-alignment.svg)
...
![어절 단위 WER과 음절 단위 CER](/assets/posts/audio-asr-wer-cer.svg)
...
![타임스탬프를 얻는 세 경로](/assets/posts/audio-asr-timestamps.svg)
