...
draft: false
---
[지난 글](/articles/rnn-lstm)에서 LSTM의 세 게이트 구조를 살펴봤다. 2014년 Cho et al.은 더 간단한 구조로도 LSTM과 비슷한 성능을 낼 수 있다는 것을 보였다—그것이 **GRU**(Gated Recurrent Unit)다. LSTM의 Forget·Input·Output 세 게이트를 **Reset·Update** 두 게이트로 압축하고, 셀 상태(C_t)를 없애 은닉 상태 하나만 유지한다.
