...
draft: false
---
[지난 글](/articles/cnn-resnet)에서 잔차 연결이 깊은 네트워크 학습을 어떻게 가능하게 했는지 살펴봤다. ResNet(2015) 이후 연구는 두 방향으로 갈라졌다. 한쪽은 **더 효율적인 CNN**—제한된 자원에서 최대 성능—을 추구했고, 다른 쪽은 **더 강력한 CNN**—Transformer의 설계 원리를 흡수—을 목표로 했다. 오늘은 양쪽의 대표 모델을 살펴본다.
