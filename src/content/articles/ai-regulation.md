...
draft: false
---
[지난 글](/articles/ai-watermarking)에서 AI 생성 콘텐츠를 추적하는 워터마킹 기술을 살펴봤다. 워터마킹을 의무화하는 법률도 등장하고 있다. AI가 산업 전반에 확산되면서 각국 정부는 어떻게 규제할지 고민하고 있다. 이 글에서는 전 세계 주요 AI 규제의 핵심을 정리한다.
