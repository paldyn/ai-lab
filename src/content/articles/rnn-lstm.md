...
draft: false
---
[지난 글](/articles/rnn-basics)에서 RNN의 핵심 문제—기울기 소실과 긴 의존성 포착의 어려움—를 확인했다. **LSTM**(Long Short-Term Memory)은 1997년 Hochreiter & Schmidhuber가 제안한 구조로, **게이트(gate)** 메커니즘을 통해 정보를 선택적으로 저장하고 삭제한다. 30년 가까이 지난 지금도 시계열, 음성 인식, 임베디드 AI 환경에서 널리 쓰인다.
...
**다음 글:** [GRU: 게이트 순환 유닛, LSTM의 경량 대안](/articles/rnn-gru)
