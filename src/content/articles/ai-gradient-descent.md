...
draft: false
---
[지난 글](/articles/ai-calculus-for-ml)에서 도함수와 그래디언트가 "어느 방향이 가장 가파른가"를 알려준다고 배웠다. 이번에는 그 정보를 사용해 모델 파라미터를 실제로 업데이트하는 알고리즘인 **경사 하강법**(Gradient Descent)을 다룬다. 딥러닝의 수십억 파라미터를 효율적으로 최적화하는 모든 방법의 뿌리가 여기에 있다.
...
**지난 글:** [미적분학: AI 학습을 가능하게 하는 수학](/articles/ai-calculus-for-ml)

**다음 글:** [옵티마이저 완전 정복: SGD에서 AdamW까지](/articles/ai-optimizers)
