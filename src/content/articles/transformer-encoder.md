...
draft: false
---
[지난 글](/articles/transformer-positional-encoding)에서 토큰의 순서 정보를 sin/cos 함수로 주입하는 방법을 배웠다. 이 정보를 담은 입력 벡터가 가장 먼저 통과하는 구조가 바로 **Encoder**다. 인코더는 입력 시퀀스 전체를 동시에 읽어 각 토큰에 '문맥이 반영된 표현'을 부여한다.
