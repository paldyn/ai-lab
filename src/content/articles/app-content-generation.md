...
draft: false
---
[지난 글](/articles/app-customer-support)에서 고객 지원 자동화를 구현했다. 이번에는 **콘텐츠 생성 자동화**를 다룬다. 마케팅 블로그 포스트, 제품 설명, 이메일 뉴스레터 등 반복적으로 생산해야 하는 텍스트 콘텐츠를 AI 파이프라인으로 자동화하는 방법이다. 중요한 것은 "AI가 쓴 것 같은" 느낌 없이 브랜드 톤을 일관되게 유지하는 것이다.
