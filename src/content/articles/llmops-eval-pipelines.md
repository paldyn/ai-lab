...
draft: false
---
[지난 글](/articles/llmops-prompt-management)에서 프롬프트를 버전 관리하고 A/B 테스트하는 방법을 다뤘다. A/B 테스트의 핵심은 "어떻게 측정하는가"다. LLM 출력을 자동으로 평가하는 **평가 파이프라인(Eval Pipeline)** 은 LLMOps의 핵심 인프라다.
