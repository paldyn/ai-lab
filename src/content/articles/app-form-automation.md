...
draft: false
---
[지난 글](/articles/app-translation)에서 AI 번역 시스템을 구축했다. 이번에는 **폼과 서류 처리 자동화**를 다룬다. 발주서, 납품확인서, 세금계산서, 입사 서류, 보험 청구서 — 기업에서 매일 처리하는 수많은 문서들이다. 이를 사람이 수동으로 읽고 시스템에 입력하는 과정을 AI로 자동화하면 처리 속도와 정확도를 동시에 높일 수 있다.
