...
draft: false
---
[지난 글](/articles/eval-task-specific)에서 태스크별 맞춤 평가 지표를 살펴보았다. 그런데 정확도나 F1 점수만으로는 놓치는 중요한 품질 차원이 있다. 바로 **편향**과 **독성**이다.
...
**지난 글:** [태스크별 맞춤 평가 지표 설계](/articles/eval-task-specific)
**다음 글:** [MLOps 완전 정복: 머신러닝을 프로덕션으로](/articles/mlops-overview)
