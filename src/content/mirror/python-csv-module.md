...
sourceSlug: "python-csv-module"
sourceUrl: "https://techblog.paldyn.com/posts/python-csv-module/"
pubDate: "2026-05-21"
syncedAt: "2026-09-08"
---

[지난 글](https://techblog.paldyn.com/posts/python-json-module/)에서 `json` 모듈로 JSON을 다루는 방법을 살펴봤습니다. 이번 글에서는 스프레드시트와 데이터 분석에서 빠질 수 없는 CSV 형식을 처리하는 `csv` 모듈을 정리합니다. 쉼표 하나로 만들어지는 단순해 보이는 형식이지만, 인용 문자, 줄바꿈, 인코딩 문제가 숨어 있어 올바른 API를 알아야 합니다.
...
![csv 모듈 구조](https://techblog.paldyn.com/assets/posts/python-csv-module-flow.svg)
...
![csv 코드 패턴](https://techblog.paldyn.com/assets/posts/python-csv-module-code.svg)
...
**지난 글:** [json 모듈: JSON 직렬화와 역직렬화](https://techblog.paldyn.com/posts/python-json-module/)

**다음 글:** [pickle: Python 객체 직렬화](https://techblog.paldyn.com/posts/python-pickle/)
