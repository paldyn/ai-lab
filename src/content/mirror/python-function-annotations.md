...
sourceSlug: "python-function-annotations"
sourceUrl: "https://techblog.paldyn.com/posts/python-function-annotations/"
pubDate: "2026-05-14"
syncedAt: "2026-09-08"
---

[지난 글](https://techblog.paldyn.com/posts/python-higher-order-functions/)에서 고차 함수를 다뤘습니다. 이번에는 함수 정의에 타입 정보를 표현하는 **어노테이션(annotation)** 을 파고듭니다. 런타임에는 강제력이 없지만, 코드 읽기·정적 분석·IDE 지원에서 어노테이션은 핵심 역할을 합니다.
...
![함수 어노테이션 문법](https://techblog.paldyn.com/assets/posts/python-function-annotations-syntax.svg)
...
![타입 힌트 버전별 변천](https://techblog.paldyn.com/assets/posts/python-function-annotations-typing.svg)
...
**지난 글:** [파이썬 고차 함수 완전 정복](https://techblog.paldyn.com/posts/python-higher-order-functions/)

**다음 글:** [파이썬 콜 스택과 트레이스백 읽기](https://techblog.paldyn.com/posts/python-call-stack-traceback/)
