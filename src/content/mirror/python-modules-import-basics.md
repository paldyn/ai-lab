...
sourceSlug: "python-modules-import-basics"
sourceUrl: "https://techblog.paldyn.com/posts/python-modules-import-basics/"
pubDate: "2026-05-10"
syncedAt: "2026-09-08"
---

[지난 글](https://techblog.paldyn.com/posts/python-script-vs-repl/)에서 스크립트 파일로 코드를 실행하는 방법을 살펴봤다. 코드가 길어지면 한 파일에 모든 것을 넣는 것은 한계가 있다. **모듈**(module)은 Python 코드를 파일 단위로 나누어 재사용하는 방법이다.
...
![import 문법 5가지 패턴](https://techblog.paldyn.com/assets/posts/python-modules-import-basics-syntax.svg)
...
![모듈 작성 → 임포트 흐름](https://techblog.paldyn.com/assets/posts/python-modules-import-basics-structure.svg)
...
**지난 글:** [스크립트 vs REPL: Python 실행 방식의 차이](https://techblog.paldyn.com/posts/python-script-vs-repl/)

**다음 글:** [셔뱅(Shebang)과 스크립트 실행](https://techblog.paldyn.com/posts/python-shebang-execution/)
