...
sourceSlug: "python-dict-basics"
sourceUrl: "https://techblog.paldyn.com/posts/python-dict-basics/"
pubDate: "2026-05-11"
syncedAt: "2026-09-08"
---

[지난 글](https://techblog.paldyn.com/posts/python-tuple/)에서 불변 시퀀스인 튜플을 살펴봤다. 이번에는 Python에서 두 번째로 자주 쓰이는 자료구조인 **딕셔너리**(dict)를 다룬다. 해시 테이블로 구현돼 있어 키 검색이 평균 O(1)이다.
...
![딕셔너리 기초](https://techblog.paldyn.com/assets/posts/python-dict-basics-overview.svg)
...
![딕셔너리 컴프리헨션](https://techblog.paldyn.com/assets/posts/python-dict-basics-comprehension.svg)
...
**지난 글:** [튜플: 불변 시퀀스의 힘과 언패킹 패턴](https://techblog.paldyn.com/posts/python-tuple/)

**다음 글:** [집합과 frozenset: 중복 없는 컬렉션](https://techblog.paldyn.com/posts/python-set-frozenset/)
