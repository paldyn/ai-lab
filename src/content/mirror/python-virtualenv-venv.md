...
sourceSlug: "python-virtualenv-venv"
sourceUrl: "https://techblog.paldyn.com/posts/python-virtualenv-venv/"
pubDate: "2026-06-01"
syncedAt: "2026-09-08"
---

[지난 글](https://techblog.paldyn.com/posts/python-pip-basics/)에서 pip로 패키지를 설치할 때 시스템 전역에는 설치하지 말라고 했다. 그 이유와 해법이 이번 글의 주제다. 프로젝트가 둘만 돼도 서로 다른 버전의 같은 라이브러리가 필요해지는 일이 금방 생기는데, 모두 한곳에 설치하면 충돌이 불가피하다. 파이썬 표준 라이브러리에 들어 있는 `venv`는 프로젝트마다 독립된 설치 공간을 만들어 이 문제를 깔끔하게 해결한다.
...
![전역 설치 vs 가상환경 격리](https://techblog.paldyn.com/assets/posts/python-virtualenv-venv-isolation.svg)
...
![venv 사용 흐름](https://techblog.paldyn.com/assets/posts/python-virtualenv-venv-lifecycle.svg)
...
**지난 글:** [pip 기초: 패키지를 설치하고 관리하기](https://techblog.paldyn.com/posts/python-pip-basics/)

**다음 글:** [Poetry: 의존성·환경·패키징을 한 도구로](https://techblog.paldyn.com/posts/python-poetry-overview/)
