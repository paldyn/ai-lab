...
sourceSlug: "python-pandas-groupby"
sourceUrl: "https://techblog.paldyn.com/posts/python-pandas-groupby/"
pubDate: "2026-06-04"
syncedAt: "2026-09-08"
---

[지난 글](https://techblog.paldyn.com/posts/python-pandas-dataframe/)에서 DataFrame으로 표를 다루는 기본기를 익혔다면, 실전에서 가장 자주 던지는 질문은 "그룹별로 어떻게 되는가"다. 도시별 평균 매출, 부서별 인원 수, 카테고리별 합계 — 이런 요약은 거의 전부 `groupby`로 풀린다. groupby는 처음엔 마법처럼 느껴지지만, 그 속은 **나누고(split), 적용하고(apply), 합치는(combine)** 세 단계의 단순한 반복이다.
...
![split → apply → combine](https://techblog.paldyn.com/assets/posts/python-pandas-groupby-split-apply-combine.svg)
...
![하나의 함수 vs 여러 집계](https://techblog.paldyn.com/assets/posts/python-pandas-groupby-agg.svg)
...
**지난 글:** [pandas DataFrame: 표 데이터의 기본 단위](https://techblog.paldyn.com/posts/python-pandas-dataframe/)

**다음 글:** [pandas merge: 표를 키로 이어 붙이기](https://techblog.paldyn.com/posts/python-pandas-merge/)
