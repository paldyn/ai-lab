...
sourceSlug: "python-gil"
sourceUrl: "https://techblog.paldyn.com/posts/python-gil/"
pubDate: "2026-05-27"
syncedAt: "2026-09-08"
---

[지난 글](https://techblog.paldyn.com/posts/python-async-context-manager/)에서 비동기 컨텍스트 매니저를 다뤘다. Python의 동시성·병렬성을 이해하려면 먼저 **GIL(Global Interpreter Lock)** 을 알아야 한다. 스레드를 여러 개 만들었는데 CPU가 하나만 돌아가는 것처럼 느껴진다면 GIL 때문이다.
...
![GIL 개념도](https://techblog.paldyn.com/assets/posts/python-gil-concept.svg)
...
![GIL 영향: CPU vs I/O](https://techblog.paldyn.com/assets/posts/python-gil-impact.svg)
...
**지난 글:** [비동기 컨텍스트 매니저](https://techblog.paldyn.com/posts/python-async-context-manager/)

**다음 글:** [threading 모듈](https://techblog.paldyn.com/posts/python-threading-module/)
