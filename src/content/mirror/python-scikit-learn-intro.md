...
sourceSlug: "python-scikit-learn-intro"
sourceUrl: "https://techblog.paldyn.com/posts/python-scikit-learn-intro/"
pubDate: "2026-06-04"
syncedAt: "2026-09-08"
---

[지난 글](https://techblog.paldyn.com/posts/python-jupyter-notebook/)에서 노트북으로 데이터를 탐색하는 작업대를 갖췄다면, 이제 그 데이터로 무언가를 예측해 볼 차례다. scikit-learn은 파이썬 머신러닝의 사실상 표준 라이브러리인데, 무엇보다 좋은 점은 **모든 모델이 똑같은 사용법을 공유한다**는 것이다. 선형회귀든 랜덤포레스트든, 일단 한 모델의 흐름을 익히면 나머지는 거의 그대로 따라온다.
...
![모든 모델은 fit → predict](https://techblog.paldyn.com/assets/posts/python-scikit-learn-intro-fit-predict.svg)
...
![왜 데이터를 나누는가](https://techblog.paldyn.com/assets/posts/python-scikit-learn-intro-train-test-split.svg)
...
**지난 글:** [Jupyter Notebook: 셀 단위로 탐색하기](https://techblog.paldyn.com/posts/python-jupyter-notebook/)

**다음 글:** [데이터 클리닝: 결측치와 이상치 다루기](https://techblog.paldyn.com/posts/python-data-cleaning-tips/)
