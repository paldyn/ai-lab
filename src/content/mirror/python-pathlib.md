...
sourceSlug: "python-pathlib"
sourceUrl: "https://techblog.paldyn.com/posts/python-pathlib/"
pubDate: "2026-05-20"
syncedAt: "2026-09-08"
---

[지난 글](https://techblog.paldyn.com/posts/python-os-module/)에서 `os` 모듈로 파일 시스템을 다루는 방법을 살펴봤습니다. `os.path.join("/home", "user", "file.txt")`처럼 함수 중심의 API는 읽기 불편할 때가 많습니다. Python 3.4에서 추가된 `pathlib` 모듈은 경로를 객체로 다루며 `/` 연산자로 이어 붙이는 직관적인 방식을 제공합니다.
...
![pathlib.Path 속성과 메서드](https://techblog.paldyn.com/assets/posts/python-pathlib-api.svg)
...
![pathlib 실전 코드 패턴](https://techblog.paldyn.com/assets/posts/python-pathlib-code.svg)
...
**지난 글:** [os 모듈 완전 정복: 파일·디렉토리·환경변수 다루기](https://techblog.paldyn.com/posts/python-os-module/)

**다음 글:** [sys 모듈: Python 인터프리터와 직접 대화하기](https://techblog.paldyn.com/posts/python-sys-module/)
