...
sourceSlug: "python-pandas-merge"
sourceUrl: "https://techblog.paldyn.com/posts/python-pandas-merge/"
pubDate: "2026-06-04"
syncedAt: "2026-09-08"
---

[지난 글](https://techblog.paldyn.com/posts/python-pandas-groupby/)에서 한 표를 그룹으로 묶어 요약했다면, 현실에서는 데이터가 한 표에 다 들어 있는 경우가 오히려 드물다. 주문 정보는 주문 테이블에, 회원 이름은 회원 테이블에 따로 있다. 분석을 하려면 이 둘을 공통 키로 이어 붙여야 한다. 데이터베이스의 JOIN에 해당하는 작업을, pandas에서는 `merge`가 담당한다.
...
![공통 키로 두 표를 잇기](https://techblog.paldyn.com/assets/posts/python-pandas-merge-on-key.svg)
...
![how= 에 따라 남는 행이 달라진다](https://techblog.paldyn.com/assets/posts/python-pandas-merge-join-types.svg)
...
**지난 글:** [pandas groupby: 나누고 적용하고 합치기](https://techblog.paldyn.com/posts/python-pandas-groupby/)

**다음 글:** [matplotlib 기초: 첫 그래프 그리기](https://techblog.paldyn.com/posts/python-matplotlib-basics/)
