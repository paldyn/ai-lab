...
sourceSlug: "python-exception-basics"
sourceUrl: "https://techblog.paldyn.com/posts/python-exception-basics/"
pubDate: "2026-05-23"
syncedAt: "2026-09-08"
---

[지난 글](https://techblog.paldyn.com/posts/python-line-endings/)에서 파일 입출력에서 줄 끝 문자를 다루는 방법을 살펴봤다. 이번에는 파일 작업을 포함한 모든 Python 코드에서 반드시 알아야 할 **예외 처리** 시스템을 심층적으로 다룬다. "오류가 나면 고치면 되지"라는 생각은 위험하다—예외를 제대로 처리하지 않으면 데이터 손실, 서버 다운, 보안 취약점으로 이어진다.
...
![Python 예외 계층 구조](https://techblog.paldyn.com/assets/posts/python-exception-basics-hierarchy.svg)
...
![try / except 기본 흐름](https://techblog.paldyn.com/assets/posts/python-exception-basics-flow.svg)
...
**지난 글:** [줄 끝 문자: \n·\r\n·\r과 크로스 플랫폼 처리](https://techblog.paldyn.com/posts/python-line-endings/)

**다음 글:** [try / except / else / finally 완전 정복](https://techblog.paldyn.com/posts/python-try-except-else-finally/)
