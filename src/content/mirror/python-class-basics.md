...
sourceSlug: "python-class-basics"
sourceUrl: "https://techblog.paldyn.com/posts/python-class-basics/"
pubDate: "2026-05-16"
syncedAt: "2026-09-08"
---

[지난 글](https://techblog.paldyn.com/posts/python-array-module/)에서 `array` 모듈로 타입 고정 배열을 다루었습니다. 이번 글부터는 Python의 핵심 기능 중 하나인 **객체 지향 프로그래밍**을 다룹니다. 클래스(class)는 데이터와 동작을 하나로 묶는 설계도이며, Python의 모든 것이 객체라는 사실을 이해하는 출발점입니다.
...
![Python 클래스 구조](https://techblog.paldyn.com/assets/posts/python-class-basics-structure.svg)
...
![클래스 정의와 사용 예제](https://techblog.paldyn.com/assets/posts/python-class-basics-code.svg)
...
**지난 글:** [array 모듈: 타입 고정 배열](https://techblog.paldyn.com/posts/python-array-module/)

**다음 글:** [인스턴스 속성 vs 클래스 속성](https://techblog.paldyn.com/posts/python-instance-vs-class-attributes/)
