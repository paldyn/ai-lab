...
sourceSlug: "python-multiprocessing-basics"
sourceUrl: "https://techblog.paldyn.com/posts/python-multiprocessing-basics/"
pubDate: "2026-05-27"
syncedAt: "2026-09-08"
---

[지난 글](https://techblog.paldyn.com/posts/python-threading-module/)에서 `threading` 모듈로 스레드를 다루는 방법을 살펴봤다. CPU 바운드 작업을 진짜로 병렬 실행하려면 GIL을 피해야 한다. `multiprocessing` 모듈은 별도의 Python 프로세스를 생성해 각 프로세스가 독립된 GIL을 갖게 하므로 멀티코어를 온전히 활용할 수 있다.

## threading vs multiprocessing

멀티스레딩은 하나의 프로세스 안에서 메모리를 공유하며 동작하고, 멀티프로세싱은 별도 프로세스를 생성해 메모리를 독립적으로 운영한다.

![멀티스레딩 vs 멀티프로세싱](https://techblog.paldyn.com/assets/posts/python-multiprocessing-basics-concept.svg)
...
![multiprocessing 기본 예제](https://techblog.paldyn.com/assets/posts/python-multiprocessing-basics-code.svg)
...
**지난 글:** [threading 모듈](https://techblog.paldyn.com/posts/python-threading-module/)

**다음 글:** [ProcessPoolExecutor](https://techblog.paldyn.com/posts/python-process-pool/)
