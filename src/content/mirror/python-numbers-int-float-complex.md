...
sourceSlug: "python-numbers-int-float-complex"
sourceUrl: "https://techblog.paldyn.com/posts/python-numbers-int-float-complex/"
pubDate: "2026-05-10"
syncedAt: "2026-09-08"
---

[지난 글](https://techblog.paldyn.com/posts/python-encoding-utf8/)에서 인코딩과 UTF-8을 살펴봤다. 이번에는 Python의 세 가지 숫자 타입 **int, float, complex**와 산술 연산자를 정리한다.
...
![Python 숫자 타입 3종](https://techblog.paldyn.com/assets/posts/python-numbers-int-float-complex-types.svg)
...
![부동소수점 정밀도와 Decimal](https://techblog.paldyn.com/assets/posts/python-numbers-int-float-complex-decimal.svg)
...
**지난 글:** [인코딩과 UTF-8: Python이 텍스트를 다루는 방식](https://techblog.paldyn.com/posts/python-encoding-utf8/)

**다음 글:** [bool과 Truthiness: 참과 거짓을 판별하는 방법](https://techblog.paldyn.com/posts/python-bool-truthiness/)
