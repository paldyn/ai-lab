...
sourceSlug: "python-string-essentials"
sourceUrl: "https://techblog.paldyn.com/posts/python-string-essentials/"
pubDate: "2026-05-10"
syncedAt: "2026-09-08"
---

[지난 글](https://techblog.paldyn.com/posts/python-bool-truthiness/)에서 bool 타입과 Truthiness를 살펴봤다. 이번에는 Python에서 가장 자주 다루는 타입 중 하나인 **문자열**(str)의 기초를 정리한다. 생성 방법부터 인덱싱, 슬라이싱, 연산자까지 차례대로 살펴본다.
...
![문자열 생성과 인덱싱](https://techblog.paldyn.com/assets/posts/python-string-essentials-basics.svg)
...
![문자열 연산과 유용한 패턴](https://techblog.paldyn.com/assets/posts/python-string-essentials-operations.svg)
...
**지난 글:** [bool과 Truthiness: 참과 거짓을 판별하는 방법](https://techblog.paldyn.com/posts/python-bool-truthiness/)

**다음 글:** [f-string: 파이썬 문자열 포매팅의 정석](https://techblog.paldyn.com/posts/python-fstring/)
