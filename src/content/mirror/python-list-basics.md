...
sourceSlug: "python-list-basics"
sourceUrl: "https://techblog.paldyn.com/posts/python-list-basics/"
pubDate: "2026-05-11"
syncedAt: "2026-09-08"
---

[지난 글](https://techblog.paldyn.com/posts/python-none/)에서 None을 살펴봤다. 이번에는 Python에서 가장 자주 쓰이는 컨테이너 타입인 **리스트**(list)를 기초부터 살펴본다.
...
![리스트 기초 — 생성·접근·수정](https://techblog.paldyn.com/assets/posts/python-list-basics-overview.svg)
...
![리스트 정렬·복사](https://techblog.paldyn.com/assets/posts/python-list-basics-sorting.svg)
...
**지난 글:** [None: Python의 '없음'을 나타내는 단 하나의 값](https://techblog.paldyn.com/posts/python-none/)

**다음 글:** [튜플: 불변 시퀀스의 힘과 언패킹 패턴](https://techblog.paldyn.com/posts/python-tuple/)
