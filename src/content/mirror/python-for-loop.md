...
sourceSlug: "python-for-loop"
sourceUrl: "https://techblog.paldyn.com/posts/python-for-loop/"
pubDate: "2026-05-12"
syncedAt: "2026-09-08"
---

[지난 글](https://techblog.paldyn.com/posts/python-if-elif-else/)에서 조건 분기를 다뤘다. 이번에는 흐름 제어의 두 번째 축인 **반복(loop)** 으로 넘어간다. Python의 `for` 문은 C/Java와 달리 숫자 인덱스가 아닌 **이터러블(iterable) 객체**를 직접 순회한다는 점이 핵심이다.
...
![for 루프 실행 메커니즘](https://techblog.paldyn.com/assets/posts/python-for-loop-overview.svg)
...
![for 루프 실전 패턴](https://techblog.paldyn.com/assets/posts/python-for-loop-patterns.svg)
...
**지난 글:** [if / elif / else: Python 조건문 완전 정복](https://techblog.paldyn.com/posts/python-if-elif-else/)

**다음 글:** [while 루프: 조건 기반 반복과 무한 루프 제어](https://techblog.paldyn.com/posts/python-while-loop/)
