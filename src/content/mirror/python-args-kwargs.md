...
sourceSlug: "python-args-kwargs"
sourceUrl: "https://techblog.paldyn.com/posts/python-args-kwargs/"
pubDate: "2026-05-13"
syncedAt: "2026-09-08"
---

[지난 글](https://techblog.paldyn.com/posts/python-default-args-pitfall/)에서 가변 객체를 기본값으로 쓸 때의 함정을 살펴봤다. 이번에는 인수 개수를 미리 정하지 않아도 되는 `*args`와 `**kwargs`를 다룬다.
...
![*args와 **kwargs 동작 원리](https://techblog.paldyn.com/assets/posts/python-args-kwargs-diagram.svg)
...
![*args + **kwargs 혼합과 언패킹](https://techblog.paldyn.com/assets/posts/python-args-kwargs-combined.svg)
...
**지난 글:** [기본 인수의 함정: 가변 객체를 기본값으로 쓰면 안 되는 이유](https://techblog.paldyn.com/posts/python-default-args-pitfall/)

**다음 글:** [키워드 전용 인수: * 이후 매개변수 강제하기](https://techblog.paldyn.com/posts/python-keyword-only-args/)
