...
sourceSlug: "python-pyproject-toml"
sourceUrl: "https://techblog.paldyn.com/posts/python-pyproject-toml/"
pubDate: "2026-06-01"
syncedAt: "2026-09-08"
---

[지난 글](https://techblog.paldyn.com/posts/python-uv-package-manager/)까지 Poetry·PDM·uv를 살펴봤는데, 이 도구들이 공통으로 읽고 쓰는 파일이 하나 있었다. 바로 `pyproject.toml`이다. 한때 파이썬 프로젝트 설정은 `setup.py`, `setup.cfg`, `requirements.txt`, 도구별 설정 파일로 흩어져 있었지만, 이제는 `pyproject.toml` 하나로 모이는 흐름이 자리 잡았다. 이번 글은 이 파일의 구조를 정면으로 들여다본다.
...
![pyproject.toml의 세 영역](https://techblog.paldyn.com/assets/posts/python-pyproject-toml-sections.svg)
...
![선언에서 빌드로](https://techblog.paldyn.com/assets/posts/python-pyproject-toml-buildflow.svg)
...
**지난 글:** [uv: Rust로 다시 쓴 초고속 패키지 매니저](https://techblog.paldyn.com/posts/python-uv-package-manager/)

**다음 글:** [setup.py vs pyproject.toml: 패키징 설정의 세대 교체](https://techblog.paldyn.com/posts/python-setup-py-vs-pyproject/)
