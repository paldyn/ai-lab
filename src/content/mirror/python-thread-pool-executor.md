...
sourceSlug: "python-thread-pool-executor"
sourceUrl: "https://techblog.paldyn.com/posts/python-thread-pool-executor/"
pubDate: "2026-05-27"
syncedAt: "2026-09-08"
---

[지난 글](https://techblog.paldyn.com/posts/python-process-pool/)에서 `ProcessPoolExecutor`로 CPU 바운드 작업을 병렬화했다. I/O 바운드 작업에는 프로세스보다 스레드가 적합하다. `ThreadPoolExecutor`는 `ProcessPoolExecutor`와 동일한 인터페이스를 가져, 두 가지를 상황에 따라 쉽게 바꿔 쓸 수 있다.
...
![ThreadPoolExecutor 작동 원리](https://techblog.paldyn.com/assets/posts/python-thread-pool-executor-concept.svg)
...
![ThreadPoolExecutor 코드 예제](https://techblog.paldyn.com/assets/posts/python-thread-pool-executor-code.svg)
...
**지난 글:** [ProcessPoolExecutor](https://techblog.paldyn.com/posts/python-process-pool/)
