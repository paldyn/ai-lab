...
sourceSlug: "python-pandas-dataframe"
sourceUrl: "https://techblog.paldyn.com/posts/python-pandas-dataframe/"
pubDate: "2026-06-04"
syncedAt: "2026-09-08"
---

[지난 글](https://techblog.paldyn.com/posts/python-numpy-basics/)에서 본 NumPy 배열은 숫자 계산에는 강하지만, 한 가지가 아쉽다. "3번째 열이 나이"라는 걸 사람이 외우고 있어야 한다는 점이다. 현실의 데이터는 엑셀 시트처럼 열마다 이름이 있고, 행마다 의미가 있다. pandas의 `DataFrame`은 NumPy 배열에 바로 그 **이름표**를 붙여, 데이터를 표처럼 직관적으로 다루게 해 준다. 데이터 분석 코드에서 가장 자주 보게 될 객체이기도 하다.
...
![DataFrame = 인덱스 + 컬럼(Series)](https://techblog.paldyn.com/assets/posts/python-pandas-dataframe-anatomy.svg)
...
![선택: 무엇을 고르느냐로 갈린다](https://techblog.paldyn.com/assets/posts/python-pandas-dataframe-select.svg)
...
**지난 글:** [NumPy 기초: ndarray와 벡터화 연산](https://techblog.paldyn.com/posts/python-numpy-basics/)

**다음 글:** [pandas groupby: 나누고 적용하고 합치기](https://techblog.paldyn.com/posts/python-pandas-groupby/)
