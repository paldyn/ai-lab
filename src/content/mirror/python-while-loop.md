...
sourceSlug: "python-while-loop"
sourceUrl: "https://techblog.paldyn.com/posts/python-while-loop/"
pubDate: "2026-05-12"
syncedAt: "2026-09-08"
---

[지난 글](https://techblog.paldyn.com/posts/python-for-loop/)에서 이터러블을 순회하는 `for` 루프를 살펴봤다. `while`은 순회할 컬렉션이 없거나 반복 횟수를 미리 알 수 없을 때 쓰는 도구다. 조건이 `True`인 동안 계속 반복하고, 조건이 `False`가 되는 순간 빠져나온다.
...
![while 루프 실행 흐름](https://techblog.paldyn.com/assets/posts/python-while-loop-overview.svg)
...
![while vs for 비교](https://techblog.paldyn.com/assets/posts/python-while-loop-patterns.svg)
...
**지난 글:** [for 루프: 반복 가능 객체 순회의 모든 것](https://techblog.paldyn.com/posts/python-for-loop/)

**다음 글:** [break와 continue: 루프 흐름 세밀하게 제어하기](https://techblog.paldyn.com/posts/python-break-continue/)
