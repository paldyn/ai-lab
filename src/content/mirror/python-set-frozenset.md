...
sourceSlug: "python-set-frozenset"
sourceUrl: "https://techblog.paldyn.com/posts/python-set-frozenset/"
pubDate: "2026-05-11"
syncedAt: "2026-09-08"
---

[지난 글](https://techblog.paldyn.com/posts/python-dict-basics/)에서 딕셔너리를 살펴봤다. 이번에는 **집합**(set)을 다룬다. 딕셔너리와 같은 해시 테이블 구조지만 키만 있고 값은 없는 컬렉션이다.
...
![set 개요](https://techblog.paldyn.com/assets/posts/python-set-frozenset-overview.svg)
...
![set 활용 패턴](https://techblog.paldyn.com/assets/posts/python-set-frozenset-patterns.svg)
...
**지난 글:** [딕셔너리 기초: 키-값 매핑의 모든 것](https://techblog.paldyn.com/posts/python-dict-basics/)

**다음 글:** [타입 변환: int, str, list, float 상호 변환](https://techblog.paldyn.com/posts/python-type-conversion/)
