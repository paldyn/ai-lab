...
sourceSlug: "python-function-def"
sourceUrl: "https://techblog.paldyn.com/posts/python-function-def/"
pubDate: "2026-05-13"
syncedAt: "2026-09-08"
---

[지난 글](https://techblog.paldyn.com/posts/python-loop-pitfalls/)에서 루프의 함정을 다뤘다. 이제 코드를 재사용 가능한 단위로 묶는 핵심 도구인 **함수**를 살펴본다. 함수를 잘 쓰는 것만으로도 코드의 가독성과 유지보수성이 극적으로 향상된다.
...
![Python 함수 해부도](https://techblog.paldyn.com/assets/posts/python-function-def-anatomy.svg)
...
![함수 정의와 호출 패턴](https://techblog.paldyn.com/assets/posts/python-function-def-examples.svg)
...
**다음 글:** [위치 인수와 키워드 인수: Python 인수 전달 방식의 기본](https://techblog.paldyn.com/posts/python-positional-keyword-args/)
