...
sourceSlug: "python-matplotlib-basics"
sourceUrl: "https://techblog.paldyn.com/posts/python-matplotlib-basics/"
pubDate: "2026-06-04"
syncedAt: "2026-09-08"
---

[지난 글](https://techblog.paldyn.com/posts/python-pandas-merge/)에서 흩어진 데이터를 하나로 모았다면, 다음 본능은 그것을 눈으로 보는 것이다. 숫자 표를 백 줄 들여다보는 것보다 그래프 하나가 추세를 훨씬 빨리 알려 준다. 파이썬 시각화의 사실상 표준은 matplotlib이고, pandas의 `.plot()`이나 seaborn도 그 위에서 돈다. 그래서 matplotlib의 기본 구조를 한 번 잡아 두면 이후 모든 시각화가 수월해진다.
...
![Figure 안에 Axes가 들어 있다](https://techblog.paldyn.com/assets/posts/python-matplotlib-basics-figure-axes.svg)
...
![기본 흐름: 만들고 → 그리고 → 꾸미고 → 보여 준다](https://techblog.paldyn.com/assets/posts/python-matplotlib-basics-workflow.svg)
...
**지난 글:** [pandas merge: 표를 키로 이어 붙이기](https://techblog.paldyn.com/posts/python-pandas-merge/)

**다음 글:** [Jupyter Notebook: 셀 단위로 탐색하기](https://techblog.paldyn.com/posts/python-jupyter-notebook/)
