...
sourceSlug: "python-dataclass"
sourceUrl: "https://techblog.paldyn.com/posts/python-dataclass/"
pubDate: "2026-05-17"
syncedAt: "2026-09-08"
---

[지난 글](https://techblog.paldyn.com/posts/python-protocol-typing/)에서 구조적 서브타이핑을 구현하는 Protocol을 살펴보았습니다. 이번에는 Python 3.7에 추가된 `@dataclass`를 다룹니다. 데이터를 담는 클래스를 만들 때마다 작성하는 `__init__`, `__repr__`, `__eq__` 보일러플레이트를 선언 한 줄로 대체합니다.
...
![@dataclass 자동 생성 메서드](https://techblog.paldyn.com/assets/posts/python-dataclass-autogen.svg)

## field()로 세밀한 제어

단순 기본값 이상이 필요할 때 `field()`를 씁니다.

![field()와 __post_init__ 활용](https://techblog.paldyn.com/assets/posts/python-dataclass-field.svg)
...
**지난 글:** [Protocol: 구조적 서브타이핑](https://techblog.paldyn.com/posts/python-protocol-typing/)

**다음 글:** [frozen dataclass: 불변 데이터 클래스](https://techblog.paldyn.com/posts/python-frozen-dataclass/)
